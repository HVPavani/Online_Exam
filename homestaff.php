...
<head>
<style>
        body{background-color: #29021A !important;}.hh{font-family:Helvatica;}</style>
    <title>
...
session_start();
                ...
                $conn = mysqli_connect('localhost','root','', 'online_Exam');if (!$conn) {
...
<body
    style="margin: 0 !important;font-weight: bolder !important;font-family: 'Courier New', Courier, monospace;height:auto;color:#fff">
    <div id="main" style="background-color: #29021A;height: auto;color:#fff !important">
        <div class="navbar" style="display: inline-flex;width: 100%;color:#042A38;position:fixed;">
            ...
            <ul
                style="display: inline-flex;padding: 0 !important;margin: 0;float: right;right: 0;position: fixed;width: 50vw;">
        ...
        <center>
            <section style="width:100vw;margin:0vw;margin-top:4vw;font-size:2vw;">Welcome to Online Examination
                System&nbsp;<?php echo $dbname ?></section>
        </center>
        <section class="dash" style="margin: 5vw;width: 90vw;">
            <center>
                <h1 style="font-weight:bolder;font-size:3vw">Dashbord</h1>
            </center>
            <center> <button onclick="addquiz()">Add Quiz</button> <button onclick="delquiz()">Delete Quiz</button>
                <button onclick="viewq()">View Quiz</button>
            </center>
            <center>
                <section id="addq" style="display:none;">
                    <form style="width: 30vw" method="post">
                        ...
                        <input type="submit" name="submit" value="submit"
                            style="height: 3vw;width: 10vw;font-family: 'Courier New', Courier, monospace;font-weight: bolder;border-radius: 10px;border: 2px solid black;background-color: lightblue;">
            ...
            <center>
                <section id="delq" style="display:none;">
                    <form style="margin: 1vw;width: 30vw" method="post">
                        ...
                        <h7 onclick="score()" style="padding:0;color: #fff;font-size:1vw;text-decoration:underline">get
                            Quiz ID</h7><br><br>
