                ...
                <div id="getcode" style="display: initial">
                    <form method="POST">
                        ...
                        <div class="signin">
                            ...
                            <br><br>
                            <input name="submit" class="sub" type="submit" value="Get the Code" style="height: 3vw;width: 10vw;font-family: 'Courier New', Courier, monospace;font-weight: bolder;border-radius: 10px;border: 2px solid black;background-color: purple;">
                    </form><br><br>
                </div>
...
if (isset($_POST['submit'])) {
    if (isset($_POST['email1']) && isset($_POST['pass1']) && isset($_POST['cpass1'])) {
        ...
        $cpassword = crypt($cpassword, 'gayatriys');
