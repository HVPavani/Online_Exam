...
if (isset($_POST['studsu'])) {
    ...
    if (isset($_POST['name1']) && isset($_POST['usn1']) && isset($_POST['mail1']) && isset($_POST['phno1']) && isset($_POST['dept1']) && isset($_POST['dob1']) && isset($_POST['gender1']) && isset($_POST['password1']) && isset($_POST['cpassword1'])) {
        ...
        $password1 = crypt($password1,'gayatriys');
        $cpassword1 = crypt($cpassword1,'gayatriys');
...
require 'sql.php';
        ...
        $password2 = crypt($password2,'gayatriys');
        $cpassword2 = crypt( $cpassword2,'gayatriys');
...
<body style="margin: 0;padding: 0;outline: none;height: 100%;min-height: 100%;color: #042A38 !important">
    <div
        style="font-family: 'Courier New', Courier, monospace;margin: 0;padding: 0;background-color: #fff;height: 100%;width: 100%;padding-bottom: 5vw;background-image: url(images/gayatri.png);height: auto !important;background-repeat: no-repeat;background-size:cover;">
        <center>
            <h1 style="text-transform: uppercase;padding: 2vw;background-color: #fff;color: #042A38;margin-top:0;">
                ONLINE
